...
const STATUS_CONFIG: Record<UploadStatus, { label: string; bg: string; text: string }> = {
  ...
  uploading:  { label: 'Uploading',   bg: colors.primaryLight,   text: colors.primary    }, // #EFF6FF / #3B82F6
  paused:     { label: 'Paused',      bg: colors.warningLight,   text: colors.warning    }, // #FFFBEB / #F59E0B
  completed:  { label: 'Completed',   bg: colors.successLight,   text: colors.success    }, // #ECFDF5 / #10B981
